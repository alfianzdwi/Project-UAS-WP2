...
class Product extends CI_Controller{
	...
	$this->session->set_flashdata("flsh_msg","<font class='success'>Produk Berhasil Ditambahkan</font>");
		redirect('product-list');
		}
	}
	public function edit_product($id_produk){
		$data['all_product'] = $this->ProductModel->edit_product_model($id_produk);
	...
	private function upload_product_image(){
        ...
        if($this->upload->do_upload('gambar_pro')){
	...
	public function update_product(){
		...
		if($_FILES['gambar_pro']['name']=="" || $_FILES['gambar_pro']['size']==""){
			$product_image= $this->input->post('old_gambar_pro',true);
			...
			redirect('edit-product/'.$id_produk);
			...
			$this->ProductModel->update_product_model($product_image);
			unlink($this->input->post('old_gambar_pro',true));
			$this->session->set_flashdata("update_pro_msg","Product Updated Successfully");
			redirect('edit-product/'.$id_produk);
		}
	...
	public function delete_product($id_produk){
		$this->ProductModel->delete_product_model($id_produk);
